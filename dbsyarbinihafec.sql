...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2037049018ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbsyarbinihafec&table=monitoring">`dbsyarbinihafec`.`monitoring`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_syarbinihafec&table=monitoring">`db_syarbinihafec`.`monitoring`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_perojek2&table=mahasiswa">`db_perojek2`.`mahasiswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_projekkalimantan&table=is_siswa">`db_projekkalimantan`.`is_siswa`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7d5d6b452c2e235e2a7c316d3a666441">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dbsyarbinihafec" targettable="monitoring">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `monitoring`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbsyarbinihafec" targettable="monitoring">
                            <div class="action_content">
